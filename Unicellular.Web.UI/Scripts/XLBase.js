...
(function (){
	...
	Object.extend(Array.prototype, arrayXLExtend);//为数组对象添加方法
	...
	Object.extend(String.prototype, stringXLExtend);//为string 对象添加加方法
	...
	var DateXLExtend = {
         ...
         * (new Date()).Format("yyyy-MM-dd E HH:mm:ss") ==> 2009-03-10 二 20:09:04       <br>
	...
	Object.extend(Date.prototype, DateXLExtend);//为Date 对象添加加方法
